...
# a job using CBS will start.
# Please use SF Jenkins Credential binding to store your credential
# to access CBS and install them in following path when you job start
